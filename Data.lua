...
_V["SORT_OPTION_ORDER"] = {
	...
	[3] = { "criteria", "questType", "questRarity", "elite", "rewardType", "rewardQuality", "rewardAmount", "canUpgrade",
		"rewardId", "seconds", "title" },
...
_V["FILTER_FUNCTIONS"] = {
	[2] = { -- Types
		["PvP"] = function(questInfo, tagInfo)
			return tagInfo(tagInfo.worldQuestType == Enum.QuestTagType.PvP or
				tagInfo.worldQuestType == Enum.QuestTagType.Bounty);
		end,
		...
		["Invasion"] = function(questInfo, tagInfo)
			return tagInfo and
					(tagInfo.worldQuestType == Enum.QuestTagType.Invasion or tagInfo.worldQuestType == Enum.QuestTagType.InvasionWrapper);
		end,
		...
		["Default"] = function(questInfo, tagInfo)
			return tagInfo and
					((not tagInfo.isElite and tagInfo.worldQuestType == Enum.QuestTagType.Normal)
						or tagInfo.worldQuestType == Enum.QuestTagType.DragonRiderRacing
						or tagInfo.worldQuestType == Enum.QuestTagType.CovenantCalling);
		end,
