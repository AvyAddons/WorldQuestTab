...
local _settings = {
	{ ["template"] = "WQT_SettingCheckboxTemplate", ["categoryID"] = "TOMTOM", ["label"] = _L["USE_TOMTOM"],
		["tooltip"] = _L["USE_TOMTOM_TT"], ["valueChangedFunc"] = function(value) _activeSettings.useTomTom = value end,
		["getValueFunc"] = function() return _activeSettings.useTomTom end
	},
	{ ["template"] = "WQT_SettingCheckboxTemplate", ["categoryID"] = "TOMTOM", ["label"] = _L["TOMTOM_AUTO_ARROW"],
		["tooltip"] = _L["TOMTOM_AUTO_ARROW_TT"],
		["valueChangedFunc"] = function(value) _activeSettings.TomTomAutoArrow = value end,
	...
	{ ["template"] = "WQT_SettingCheckboxTemplate", ["categoryID"] = "TOMTOM", ["label"] = _L["TOMTOM_CLICK_ARROW"],
		["tooltip"] = _L["TOMTOM_CLICK_ARROW_TT"], ["valueChangedFunc"] = function(value)
			_activeSettings.TomTomArrowOnClick = value

			if (
				not value and WQT_WorldQuestFrame.softTomTomArrow and
					not WQT_Utils:QuestIsWatchedManual(WQT_WorldQuestFrame.softTomTomArrow)) then
...
local function QuestListChangedHook(event, ...)
	...
	if (
		questId and TomTom and _activeSettings.useTomTom and (clickArrow or autoArrow) and
			QuestUtils_IsQuestWorldQuest(questId)) then
...
function TomTomExternal:Init(utils)
	...
	WQT_WorldQuestFrame:RegisterCallback("WorldQuestCompleted",
		function(questId) WQT_Utils:RemoveTomTomArrowbyQuestId(questId) end)
